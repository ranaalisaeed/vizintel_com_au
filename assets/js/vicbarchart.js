...
d3.csv("/data4viz/sales-openrefined.csv",
	...
	function (d) {
		...
		options.property('selected', function (d) { return d === 'All'})
		...
		dropdown.on('change', function () {
			...
			if (selectedSub == 'All') {
				updateChart(data_stack_init)	
			} else {
				// console.log('selectedSub', selectedSub)
				updateChart(data_stack_filt.filter(function (d) { 
					return d.suburb == selectedSub; 
				}))
			}
		})
